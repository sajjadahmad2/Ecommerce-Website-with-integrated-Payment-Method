...
if (isset($_SESSION['username'])) {
  ...
  header("location:http://localhost/organi-master");
}
...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row  = mysqli_fetch_assoc($result)) {
      ...
      $_SESSION['cart']=[];
      header("location:http://localhost/ogani-master");
    }
  } else {
...
if (isset($_POST['signup'])){
  ...
  $email=$_POST['email'];
  $date=date('Y-m-d');
  $sql="insert into user(firstname,lastnameusername,password,email,datecreated) values('$firstname','$lastname','$username'.'$password','$email','$date')";
...
<body>
    ...
    <form method="Post" id="loginform"> 
        ...
        <label for="username">Username</label>
        <input type="text" placeholder="Email or Phone" name="logusername">
